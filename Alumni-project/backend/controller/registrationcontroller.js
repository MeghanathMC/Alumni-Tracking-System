...
const initiatestudentregister = async (req, res,next) => {
    try {
...
const completestudentregister= async(req,res) => {
    try {
...
module.exports={initiatestudentregister,completestudentregister,getUsersByBatchYear};